...
import EfxHeader from 'public/icons/efx-header.svg'
...
const HeroBackground = () => {
  ...
  return (
    <>
      ...
      {/* <div
        aria-hidden
        className="bg-brand-350 pointer-events-none absolute -top-12 -left-12 h-[2515px] w-133.5 rounded-full opacity-80 mix-blend-screen blur-[80px]"
      /> */}
      ...
      <EfxHeader className="pointer-events-none absolute bottom-0" />
    </>
  );
};
