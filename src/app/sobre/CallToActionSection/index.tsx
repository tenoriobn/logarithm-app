...
const CallToActionSection = () => {
  return (
    <section className="bg-surface-950 3xl:p-[1.666vw] 3xl:gap-[1.666vw] relative grid min-h-svh grid-rows-[1fr_auto_1fr] gap-4 p-4 md:gap-8 md:p-8">
      <div
        aria-hidden
        className="absolute inset-0 bg-[linear-gradient(0deg,#102531_0%,rgba(14,31,41,0.132212)_20%,rgba(14,31,41,0)_50%,rgba(14,31,41,0.13)_80%,rgba(14,31,41)_100%)] bg-size-[100%_100%,100%_100%]"
      />

      <div aria-hidden />

      <section className="3xl:gap-[1.666vw] relative z-2 row-start-2 flex flex-col items-center justify-center gap-4 md:gap-8">
