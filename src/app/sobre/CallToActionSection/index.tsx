    ...
    <section className="bg-surface-950 3xl:gap-[1.666vw] 3xl:p-[1.666vw] relative flex min-h-svh flex-col items-center justify-center gap-4 p-4 md:gap-8 md:p-8">
      ...
      <div className="3xl:space-y-[0.833vw] z-2 space-y-4">
        ...
        <SectionDescription
          ...
          className="3xl:max-w-[50vw] mx-auto max-w-155 xl:max-w-240"
        >
      ...
      <Link
        ...
        className="border-brand-600 bg-button-brand 3xl:text-[1.25vw] 3xl:gap-[0.833vw] 3xl:p-[.417vw] 3xl:pl-[1.666vw] z-2 flex items-center justify-center gap-4 rounded-full border p-2 pl-8 font-medium text-white/75 md:text-2xl"
      >
        ...
        <div className="border-brand-500/25 bg-brand-700 3xl:p-[0.833vw] flex items-center justify-center rounded-full border p-3 md:p-4">
          <ArrowIcon className="3xl:w-[1.25vw] 3xl:h-[1.25vw] h-4 w-4 md:h-6 md:w-6" />
        </div>
      </Link>
    </section>
  );
