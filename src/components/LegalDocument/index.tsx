...
export const LegalPage = ({ children }: { children: React.ReactNode }) => {
  return (
    <SmoothScrolling>
      <Header />
      <main className="bg-surface-850 flex flex-1 flex-col">
        {children}
      </main>
      <LegalFooter />
    </SmoothScrolling>
...
export const LegalHeader = ({ title, lastUpdated }: { title: string; lastUpdated: string }) => {
  return (
    <section aria-labelledby="legal-section-title" className="bg-surface-gradient 3xl:px-[1.666vw] 3xl:py-[6.667vw] px-4 py-24 md:px-8 md:py-32">
      <SectionTitle
...
export const LegalContent = ({ children, ariaLabel }: { children: React.ReactNode; ariaLabel: string }) => {
  return (
    <section aria-label={ariaLabel} className="text-gradient text-gradient-white 3xl:px-[1.666vw] 3xl:space-y-[3.332vw] space-y-8 px-4 md:space-y-16 md:px-8">
      {children}
    </section>
  );
};
...
export const LegalParagraph = ({ children }: { children: React.ReactNode }) => {
  return (
    <p className="3xl:text-[1.25vw] text-base md:text-2xl">
      {children}
    </p>
  );
};
...
export const LegalListItem = ({ children }: { children: React.ReactNode }) => {
  return (
    <li className="3xl:text-[1.25vw] text-base md:text-2xl">
      {children}
    </li>
  );
};
